      ...
      <section className="section section-bg">
        <div className="container">
          ...
          <div className="why-choose-grid">
            {[
              { icon: <svg viewBox="0 0 24 24"><path d="M12 2L3 6v6c0 5.5 3.8 10.7 9 12 5.2-1.3 9-6.5 9-12V6l-9-4zm5 10c0-1.5-.3-3-.8-4-.2-.5-.3-1-.2-1.5 0-1-.5-1.5-2-1.5s-2 .5-2 1.5c.1.5 0 1-.2 1.5-.5 1-.8 2.5-.8 4 0 .2.1.4.3.3l1.5-.4c.3-.1.6 0 .9.2.3.2.7.2 1 0 .3-.2.6-.3.9-.2l1.5.4c.2.1.3-.1.3-.3l-.2-2z" /></svg>, title: 'Certified Expert Lead', desc: 'All complex implants and surgeries are directly performed by Dr. Sardar Ali (BDS, RDS).' },
              { icon: <svg viewBox="0 0 24 24"><path d="M10 2c-2.4 0-3.6 1.2-3.6 2.8 0 1.6.4 3.2 1.2 4.4.4.8.6 1.6.4 2.4l-.4 3.2c-.1.4.2.8.6.7l2.5-.8c.4-.1.8 0 1.1.2.4.2.9.2 1.3 0 .4-.2.8-.2 1.1-.1l2.5.8c.4.1.7-.3.6-.7l-.4-3.2c-.2-.8 0-1.6.4-2.4 1-1.2 1.2-2.8 1.2-4.4C13.6 3.2 12.4 2 10 2z" /><path d="M19 12a4 4 0 100 8 4 4 0 000-8zm-1.5 5.5l-1.5-1.5 1-1 0.5 0.5 2-2 1 1-3 3z" /></svg>, title: 'Sterility & Safety First', desc: 'We follow rigorous multi-phase instrument disinfection protocols to secure clinical standards.' },
              { icon: <svg viewBox="0 0 24 24"><path d="M10 4c-2.4 0-3.6 1.2-3.6 2.8 0 1.6.4 3.2 1.2 4.4.4.8.6 1.6.4 2.4l-.4 3.2c-.1.4.2.8.6.7l2.5-.8c.4-.1.8 0 1.1.2.4.2.9.2 1.3 0 .4-.2.8-.2 1.1-.1l2.5.8c.4.1.7-.3.6-.7l-.4-3.2c-.2-.8 0-1.6.4-2.4 1-1.2 1.2-2.8 1.2-4.4C13.6 5.2 12.4 4 10 4z" /><path d="M21 7.2a7.5 7.5 0 01-9.2 9.2 7.5 7.5 0 109.2-9.2z" /></svg>, title: 'Comfortable Sedations', desc: 'Specialized sedative methods are available to manage dental anxieties during extraction or alignments.' },
            ].map((c, i) => (
